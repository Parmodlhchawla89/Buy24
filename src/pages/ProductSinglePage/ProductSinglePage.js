            ...
            <div className='product-single-l'>
              <div className='product-img'>
                <div className='product-img-zoom'>
                  <img
                    src={
                      product && Array.isArray(product.images) && product.images.length > 0 && product.images[0]?.url
                ...
                <div className='product-img-thumbs flex align-center my-2'>
                  {Array.isArray(product?.images) && product.images.length > 0 && product.images.some(img => img?.url) ? (
                    ...
                    <div className='thumb-item'>
                      <img src={require('../../assets/images/slider_img_1.jpg')} alt="" className='img-cover' />
                    </div>
                  )}
                </div>
              </div>
